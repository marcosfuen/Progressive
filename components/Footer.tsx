        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12 lg:mb-16">
          <div className="text-center md:text-left flex flex-col items-center md:items-start">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white text-blue-950 rounded-lg flex items-center justify-center shadow-lg">
                <svg 
                  viewBox="0 0 100 100" 
              ...
              <div className="flex flex-col text-left">
                <span className="font-black text-lg sm:text-xl tracking-tighter leading-none uppercase">PROGRESSIVE</span>
                <span className="text-[8px] sm:text-[9px] font-black text-blue-300 uppercase tracking-[0.2em] leading-none mt-1">Freight Logistics LLC</span>
              </div>
            </div>
          ...
          <div className="flex flex-col items-center lg:items-end">
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#25D366] transition-all hover:-translate-y-1" 
                aria-label="WhatsApp"
              >
              ...
              <a href="#" className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-blue-600 transition-all hover:-translate-y-1" aria-label="Facebook">
